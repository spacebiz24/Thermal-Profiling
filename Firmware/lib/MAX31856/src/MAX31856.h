...
private:
    ...
    int totalNumberofRWRegisters = 10;

    /// \brief A variable containing values of the registers that can be read and written to
    byte RWRegisterValues[10] = {0x90, 0x03, 0xFC, 0x7F, 0xC0, 0x7F, 0xFF, 0x80, 0x00, 0x00};
    ...
    byte RWRegisterAddresses[10] = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09};
...
public:
     ...
     * \param CSPin The chip select pin for the MAX31856
     */
    MAX31856(int CSPin);
